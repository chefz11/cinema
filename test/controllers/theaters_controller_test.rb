...
class TheatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create theater" do
    assert_difference('Theater.count') do
      post theaters_url, params: { theater: { cleaned: @theater.cleaned, movie: @theater.movie, number: @theater.number } }
    end
  ...
  test "should update theater" do
    patch theater_url(@theater), params: { theater: { cleaned: @theater.cleaned, movie: @theater.movie, number: @theater.number } }
